...
import 'package:rally_sample/data/rally_options.dart';
import 'package:rally_sample/layout/adaptive.dart';
import 'package:rally_sample/layout/text_scale.dart';
import 'package:rally_sample/tabs/accounts.dart';
import 'package:rally_sample/tabs/bills.dart';
import 'package:rally_sample/tabs/budgets.dart';
import 'package:rally_sample/tabs/overview.dart';
import 'package:rally_sample/tabs/settings.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (isDesktop) {
      final isTextDirectionRtl =
          RallyOptions.of(context).resolvedTextDirection() ==
              TextDirection.rtl;
  ...
  List<Widget> _buildTabs(
    ...
    return [
      ...
      _RallyTab(
        ...
        title: GalleryLocalizations.of(context)!.tabTitleSettings,
        tabIndex: 4,
        tabController: _tabController,
        isVertical: isVertical,
      ),
...
class _RallyTabBar extends StatelessWidget {
  const _RallyTabBar({Key? key, required this.tabs, required this.tabController})
      : super(key: key);
