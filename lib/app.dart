...
import 'package:rally_sample/home.dart';
import 'package:rally_sample/login.dart';
import 'package:rally_sample/routes.dart' as routes;
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: _buildRallyTheme().copyWith(
        platform: RallyOptions.of(context).platform,
      ...
      locale: RallyOptions.of(context).locale,
