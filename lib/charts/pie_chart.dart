...
import 'package:rally_sample/layout/letter_spacing.dart';
import 'package:rally_sample/layout/text_scale.dart';
import 'package:rally_sample/colors.dart';
import 'package:rally_sample/data.dart';
import 'package:rally_sample/formatters.dart';
...
class _AnimatedRallyPieChart extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (RallyOptions.of(context).textScaleFactor(context) > 1.0) {
...
class _RallyPieChartOutlineBoxPainter extends BoxPainter {
  _RallyPieChartOutlineBoxPainter(
      {required this.maxFraction, required this.wholeAmount, required this.segments});
