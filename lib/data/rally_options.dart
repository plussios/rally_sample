...
import 'package:rally_sample/constants.dart';
...
class RallyOptions {
  ...
  static RallyOptions of(BuildContext context) {
    final scope =
    context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope!.modelBindingState.currentModel;
  }

  static void update(BuildContext context, RallyOptions newModel) {
    final scope =
    context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
/// Applies text [RallyOptions] to a widget
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = RallyOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ...
  final RallyOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  late RallyOptions currentModel;
  ...
  void handleTimeDilation(RallyOptions newModel) {
  ...
  void updateModel(RallyOptions newModel) {
